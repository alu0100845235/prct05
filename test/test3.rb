...
class TestPoint < Test::Unit::TestCase
  def test_simple
    assert_equal("2/1", (Fraccion.new(4,1) - Fraccion.new(2,1)).to_s)
    assert_equal("1/1", (Fraccion.new(4,2) - Fraccion.new(2,2)).to_s)
    assert_equal("1/4", (Fraccion.new(1,2) - Fraccion.new(1,4)).to_s)
    assert_equal("-7/12", (Fraccion.new(3,4) - Fraccion.new(4,3)).to_s)
